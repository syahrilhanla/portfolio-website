...
const Works = () => {
	return (
		<section
			className={`text-gray-300 flex flex-col justify-center items-center text-center md:px-[8rem] px-[2rem] pb-7 transition-all duration-700 ease-out`}
			name="works"
		>
			<div className="flex flex-col sm:mt-3 mt-[6rem] w-full max-w-5xl">
				...
				<div className="flex flex-col gap-16 w-full">
					{workData.map((data, idx) => (
						...
						>
							{/* Image section */}
							<div className="md:w-7/12 w-full h-64 md:h-[340px] rounded-lg overflow-hidden shadow-lg border border-slate-800 bg-[#181f33] relative group-hover:scale-105 group-hover:shadow-pink-500/20 transition-all duration-300">
								<div
							...
							<div className="md:w-8/12 w-full flex flex-col justify-center md:items-end items-center md:pl-0 md:pr-8 mt-6 md:mt-0 relative z-10">
								...
								>
									...
									<h3 className="text-2xl md:text-3xl font-bold text-slate-100 mb-4 md:mb-2 hover:text-pink-300 duration-200 transition-colors">
										<a
