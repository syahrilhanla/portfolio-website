const About = () => {
	return (
		<div className="min-h-screen text-slate-300 bg-[#0c2852] flex justify-center items-center md:px-10 px-3 md:pb-0 pb-5">
			<div className="md:grid grid-cols-2 gap-x-8 w-[70%] mt-10 md:mt-0">
